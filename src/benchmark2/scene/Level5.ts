...
export class Level5_1 extends GameLevel {
    loadScene(): void {
        ...
        this.load.tilemap("level", "res/tilemaps/Level5_1.json"); // Load tile map
...
export class Level5_2 extends GameLevel {
    loadScene(): void {
      ...
      this.load.tilemap("level", "res/tilemaps/Level5_2.json"); // Load tile map
...
export class Level5_3 extends GameLevel {
  loadScene(): void {
    this.loadMainResources();
    this.load.tilemap("level", "res/tilemaps/Level5_3.json"); // Load tile map
