...
import Room2 from "./level_1/Room2"; //testing
import Room3 from "./level_1/Room3"; //testing
import Room4 from "./level_1/Room4"; //testing
...
export default class MainMenu extends Scene {
  ...
  initLevelSelectScene(center: Vec2): void {
    ...
    // Level Select Header
    const leaderboardHeader = <Label>this.add.uiElement(
      UIElementType.LABEL,
      "levelSelect",
      {
  ...
  initControlScene(center: Vec2): void {
    ...
    const controlsHeader = <Label>this.add.uiElement(
      UIElementType.LABEL,
      "controls",
      {
        position: new Vec2(center.x, center.y - 300),
  ...
  initLeaderboardScene(center: Vec2): void {
    ...
    const score = <Label>this.add.uiElement(
      UIElementType.LABEL,
      "leaderboard",
      {
        position: new Vec2(center.x + 300, center.y - 200),
